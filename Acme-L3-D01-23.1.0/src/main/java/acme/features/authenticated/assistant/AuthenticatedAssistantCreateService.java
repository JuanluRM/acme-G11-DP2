...
public class AuthenticatedAssistantCreateService extends AbstractService<Authenticated, Assistant> {
	...
	public void authorise() {
		...
		status = !this.getRequest().getPrincipal().hasRole(Assistant.class);
	...
	public void bind(final Assistant object) {
		...
		super.bind(object, "supervisor", "expertiseFields", "resume", "infoLink");
	}
	...
	public void unbind(final Assistant object) {
		...
		tuple = super.unbind(object, "supervisor", "expertiseFields", "resume", "infoLink");
