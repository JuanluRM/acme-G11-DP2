...
public class AuthenticatedAuditShowService extends AbstractService<Authenticated, Audit> {
	...
	public void unbind(final Audit audit) {
		...
		final Auditor auditor = this.repo.findAuditorByAuditId(audit.getId());

		tuple = super.unbind(audit, "code", "conclusion", "strongPoints", "weakPoints", "note");
		...
		tuple.put("certificationsList", auditor.getCertificationsList());
