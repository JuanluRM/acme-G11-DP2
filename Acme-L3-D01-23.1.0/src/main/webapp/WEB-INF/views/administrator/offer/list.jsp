...
<acme:list>
	<acme:list-column code="administrator.offer.list.label.instantiationMoment" path="instantiationMoment"/>
	...
	<acme:list-column code="administrator.offer.list.label.start" path="start"/>
	<acme:list-column code="administrator.offer.list.label.end" path="end"/>
