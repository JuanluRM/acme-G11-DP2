...
<acme:menu-bar code="master.menu.home">
	...
	<acme:menu-option code="master.menu.anonymous" access="isAnonymous()">
		...
		<acme:menu-option code="master.menu.pabquide" access="isAnonymous()">
			<acme:menu-suboption code="master.menu.anonymous.favourite-link" action="https://www.fernandoalonso.com/"/>
		</acme:menu-option>
		
		<acme:menu-option code="master.menu.maria" access="isAnonymous()">
			<acme:menu-suboption code="master.menu.anonymous.favourite-link" action="https://www.mariaruvaz.com/"/>
		</acme:menu-option>
		
		<acme:menu-option code="master.menu.juaruamur" access="isAnonymous()">
		...
		<acme:menu-option code="master.menu.any">			
			...
			<acme:menu-suboption code="master.menu.any.audit" action="/any/audit/list"/>
		</acme:menu-option>
		...
		<acme:menu-option code="master.menu.company" access="hasRole('Company')">
			<acme:menu-suboption code="master.menu.company.practica.list" action="/company/practica/list"/>
		</acme:menu-option>
		...
		<acme:menu-option code="master.menu.auditor" access="hasRole('Auditor')">			
			...
			<acme:menu-suboption code="master.menu.auditor.auditorDashboard" action="/auditor/auditor-dashboard/show"/>
		</acme:menu-option>
