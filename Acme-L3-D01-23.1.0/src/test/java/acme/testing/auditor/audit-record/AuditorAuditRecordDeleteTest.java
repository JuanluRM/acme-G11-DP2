...
public class AuditorAuditRecordDeleteTest extends TestHarness {
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/auditor/audit-record/delete-positive.csv", encoding = "utf-8", numLinesToSkip = 1)
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/auditor/audit-record/delete-hacking.csv", encoding = "utf-8", numLinesToSkip = 1)
