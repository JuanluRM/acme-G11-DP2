...
public class TutorialListTest extends TestHarness {
	...
	public void test100Positive(final int tutorialRecordIndex, final String code, final String title, final String published) {
		...
		super.checkColumnHasValue(tutorialRecordIndex, 2, published);
