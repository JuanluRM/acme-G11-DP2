...
public class CompanySessionUpdateTest extends TestHarness {
	...
	public void test100Positive(final int practicaRecordIndex, final int sessionRecordIndex, final String title, final String summary, final String startDate, final String endDate, final String link) throws InterruptedException {
	...
	public void test200Negative(final int practicaRecordIndex, final int sessionRecordIndex, final String title, final String summary, final String startDate, final String endDate, final String link) {
		...
		for (final Practica practica : practicas)
			if (!practica.getDraftMode() || practica.getDraftMode()) {
				...
				for (final Session session : sessions) {
					...
					super.request("/company/session/update", param);
